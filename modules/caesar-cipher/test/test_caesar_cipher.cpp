...
TEST_F(CaesarCipherTest, Can_Encrypt_Empty_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(empty_message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Empty_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(empty_message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Empty_Message_With_Negative_Key) {
    // Act & Assert
...
TEST_F(CaesarCipherTest, Can_Encrypt_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Message_With_Negative_Key) {
    // Act & Assert
...
TEST_F(CaesarCipherTest, Can_Encrypt_Complex_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(complex_message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Complex_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Encrypt(complex_message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Encrypt_Complex_Message_With_Negative_Key) {
    // Act & Assert
...
TEST_F(CaesarCipherTest, Can_Decrypt_Empty_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(empty_message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Empty_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(empty_message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Empty_Message_With_Negative_Key) {
    // Act & Assert
...
TEST_F(CaesarCipherTest, Can_Decrypt_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Message_With_Negative_Key) {
    // Act & Assert
...
TEST_F(CaesarCipherTest, Can_Decrypt_Complex_Message_With_Zero_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(complex_message, zero_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Complex_Message_With_Positive_Key) {
    // Act & Assert
    EXPECT_NO_THROW(CaesarCipher::Decrypt(complex_message, positive_key));
}

TEST_F(CaesarCipherTest, Can_Decrypt_Complex_Message_With_Negative_Key) {
    // Act & Assert
