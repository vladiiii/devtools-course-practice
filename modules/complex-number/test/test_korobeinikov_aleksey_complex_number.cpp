...
TEST(Korobeinikov_Aleksey_ComplexCalculatorTest, Can_Do_Simple_Operations) {
    ...
    // Act
    string ans1 = app(6, arr1);
    string ans2 = app(6, arr2);

    // Assert
    string expected_ans1 = "Real = -1 Imaginary = 12.12";
    string expected_ans2 = "Real = 9 Imaginary = 36.72";
